...
public class MedecinProfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_medecin_profil);
        mAuth = FirebaseAuth.getInstance();
        user = mAuth.getCurrentUser();

        ref = FirebaseDatabase.getInstance().getReference().child("Medecins").child(user.getUid().toString());
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                patient = dataSnapshot.getValue(Medecin.class);
                ...
                profile_sf.setText(patient.getSpecialite());
        ...
        profile_email_block.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(MedecinProfil.this);
                ...
                btn_okay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(MedecinProfil.this,diagnom.toString(), Toast.LENGTH_SHORT).show();
        ...
        profile_sf_block.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                titre.setText("Specialite");
                ancien.setText("specialité: "+patient.getAdresse());


                diagnom.setHint("Nouvelle specialité... ");
                diagnom.setVisibility(view.VISIBLE);
                ...
                btn_okay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ref.child("specialite").setValue(diagnom.getText().toString());
                        alertDialog.dismiss();
                    }
                });
                alertDialog.show();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MedecinProfil.this, medecinHome.class));
            }
        });
    }
